...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edUsername = findViewById(R.id.editTextTextPersonName9);
        edPassword = findViewById(R.id.editTextTextPersonName11);
        edEmail = findViewById(R.id.editTextTextPersonName10);
        edConfirm = findViewById(R.id.editTextTextPersonName12);
